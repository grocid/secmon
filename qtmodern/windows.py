from qtpy.QtCore import Qt, QMetaObject, Signal, Slot, QRectF, QRect
from qtpy.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QToolButton,
                            QLabel, QSizePolicy)
from qtpy.QtGui import QIcon, QPainter, QPainterPath, QColor
...
if False:
    SIDEBAR = QColor(12, 14, 20)
    BACKGROUND = QColor(24, 28, 40)
elif False:
    SIDEBAR = QColor(45, 45, 45)
    BACKGROUND = QColor(54, 54, 54)
else:
    SIDEBAR = QColor(239, 239, 239)
...
class ModernWindow(QWidget):
    ...
    def __init__(self, w, parent=None):
        ...
        contentLayout.setContentsMargins(0, 0, 10, 10)
    ...
    def setupUi(self):
        ...
        self.hboxTitle.setContentsMargins(10, 10, 10, 0)
        ...
        self.btnSettings = QToolButton(self.titleBar)
        self.btnSettings.setObjectName('btnSettings')
        self.btnSettings.setSizePolicy(spButtons)
        ...
        if True:
            ...
            self.hboxTitle.addWidget(self.btnSettings)
        else:
            self.hboxTitle.addWidget(self.lblTitle)
            self.hboxTitle.addWidget(self.btnMinimize)
            self.hboxTitle.addWidget(self.btnRestore)
    ...
    def _setWindowButtonState(self, hint, state):
        ...
        if True in [b.isEnabled() for b in allButtons]:
            ...
            if maximized:
                ...
                self.btnRestore.setVisible(False)
            self.lblTitle.setContentsMargins(150, 0, 0, 0)
        else:
            for b in allButtons:
                b.setVisible(False)
